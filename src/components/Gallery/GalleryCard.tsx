                        ...
                        i === previewLength - 1 ?
                            ...
                            >
                                <div className="relative h-full w-full rounded bg-black text-gray-400 hover:text-white">
                                    <BlurryImage className="h-full w-full rounded bg-gray-400 object-cover opacity-50" src={mediaPath(img.name, GallerySizes.PREVIEW)} nsfw={img.NSFW}/>
                            ...
                            >
                                <div className="hover:bg-black rounded h-full w-full">
                                    <BlurryImage className="h-full w-full rounded bg-gray-400 object-cover hover:opacity-75 " src={mediaPath(img.name, GallerySizes.PREVIEW)} nsfw={img.NSFW}/>
                                </div>
                            </Link>
                    )) :
