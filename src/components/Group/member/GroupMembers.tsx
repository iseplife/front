    ...
    return (
        loading ?
            ...
            <div>
                ...
                <CompressedMembers className="cursor-pointer hover:bg-black hover:bg-opacity-5 transition-colors rounded-lg p-2 w-full" members={[1, 1, 1, 1, 1, 1, 1, 1, 1].map(_ => orga[0].map(gm => gm.student)[0])}/>
            </div>
    )
}
