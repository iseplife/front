...
export const searchEvent = (name: string, page: number, token?: CancelToken): AxiosPromise<Page<SearchItem>> =>
    apiClient.get("/search/event", {params: {name: name, page: page}, cancelToken: token})
