...
import { downloadFile, formatDateWithTimer, limitSize, mediaPath, releaseCanvas, shareImage as sImage } from "../../../util"
    ...
    return (
        <div>
            <div className="flex flex-col p-4">
                <div className="hidden md:flex w-full justify-between items-center mb-1">
                    <div className="flex">
                        <StudentAvatar
                            id={gallery.club.id}
                    ...
                    <div className="flex space-x-2">
                        {canShare &&
                            <button onClick={downloadProgress == -1 ? shareImage : undefined} className="rounded-full flex items-center justify-center h-10 w-10 relative overflow-hidden bg-indigo-400 hover:opacity-90 hover:shadow transition-all text-white font-medium">
                        ...
                        <button onClick={downloadProgress == -1 ? downloadImage : undefined} className="rounded-full flex items-center justify-center h-10 w-10 relative overflow-hidden bg-indigo-400 hover:opacity-90 hover:shadow transition-all text-white font-medium">
                ...
                <div className="md:hidden absolute navbar m-3.5 top-0 right-0 flex space-x-4">
                    {canShare &&
                        <button
                            ...
                            className="w-9 h-9 flex overflow-hidden bg-indigo-400 hover:opacity-90 hover:shadow all rounded-full text-white font-medium px-2 items-center justify-center relative"
                        >
                            <div className="bg-indigo-500 top-0 left-0 absolute h-full" style={{ width: `${downloadProgress == -1 || isDownloadingImage ? 0 : downloadProgress * 100}%` }}></div>
                            <div className="
